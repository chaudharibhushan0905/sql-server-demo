...
--IN -selects all customers that are located in "Germany", "France" or "UK":
SELECT * FROM customer1
...
values('Chais',1,1,'boxes x 20 bags',18)
insert into Product1
values('Chang',1,1,'24 - 12 oz bottles',19)
insert into Product1
values('Aniseed Syrup',1,2,'	12 - 550 ml bottles',10)
insert into Product1
values('Chef Antons Cajun Seasoning',1,2,'	48 - 6 oz jars',22)
insert into Product1
values('Chef Antons Gumbo Mix',1,2,'	36 boxes',21.35)
